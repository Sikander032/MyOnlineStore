<template>
        <div class="modal-quick-view modal fade" :id="'quick-view'+product.id" tabindex="-1">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title product-title"><a href="shop-single-v1.html" data-bs-toggle="tooltip"
                                                                 data-bs-placement="right" title="Go to product page">{{ product.category_name }}<i class="ci-arrow-right fs-lg ms-2"></i></a></h4>
                            ...
                            <div class="col-lg-7 pe-lg-0">
                                <div class="product-gallery">
                                    <div class="product-gallery-preview order-sm-2">
                                        <div  v-for="image in product.images" :key="image.id" class="product-gallery-preview-item"
                                              :class="{'active' : image.id === 8 }" :id="image.id"><img
                                            class="image-zoom" :src="'img/shop/catalog/'+image.image_path"
                                            :data-zoom="'img/shop/catalog/'+image.image_path" alt="Product image">
                                            <div class="image-zoom-pane"></div>
                                        </div>
<!--                                        <div class="product-gallery-preview-item active" id="second"><img class="image-zoom"-->
...
<!--                                        </div>-->
                                    ...
                                    <div  class="product-gallery-thumblist order-sm-1">
                                        <a v-if="product.images.length > 0" v-for="image in product.images"
                                        class="product-gallery-thumblist-item" :class="{'active' : image.id === 8 }" :href="'#'+image.id"><img
                                        :src="'img/shop/catalog/'+image.image_path" alt="Product thumb"></a>
<!--                                        <a-->
                            ...
                            <div class="col-lg-5 pt-4 pt-lg-0 image-zoom-pane">
                                <div class="product-details ms-auto pb-3">
                                    <div class="d-flex justify-content-between align-items-center mb-2"><a
                                        ...
                                        <span
                                            class="d-inline-block fs-sm text-body align-middle mt-1 ms-1">74 Reviews</span></a>
                                    ...
                                    <div class="mb-3"><span class="h3 fw-normal text-accent me-1">$18.<small>99</small></span>
                                        <del class="text-muted fs-lg me-3">$25.<small>00</small></del>
                                    ...
                                    <div class="position-relative me-n4 mb-3">
                                        ...
                                        <div class="product-badge product-available mt-n1"><i
                                            class="ci-security-check"></i>Product available
                                        </div>
                                    </div>
